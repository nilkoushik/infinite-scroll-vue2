<!-- <template>
  <div>
    ...
    <div role="group" class="" style="padding: 0px;"></div>
    <div role="tfoot" class="loader-wrapper"></div>
...
import Item from "./virtual-list-item.vue";
import Slot from "./virtual-list-slot.vue";
...
export default {
  ...
  mounted() {
    ...
    //this._render(document.createElement);
    if (this.start) {
  ...
  methods: {
    ...
    installVirtual() {
      ...
      console.log(this.virtual, this.virtual.getRange())
      // sync initial range
